...
const manifest = [{
    "module": "@anti-matter-studios/tools/*",
    "pattern": "libs/tools/src/lib/*",
}, {
    "module": "@anti-matter-studios/amphitrite",
    "exactMatch": "apps/amphitrite/src/index.js",
    "pattern": "apps/amphitrite/src/index.ts",
}];
